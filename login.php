   ...
   <div class="form-container">
        <form action="" method="post" enctype="multipart/form-data">
            <h3 style="font-size:23px; color: #0D7377; word-spacing:3px; background-color:#333; border-radius: 5px; color: #30E3CA; box-shadow:0 10px 10px rgba(0,0,0,.1);"
                class="headertext">
                <i class="fas fa-music"></i> BIENVENIDO A MUSIVERSE
            </h3>
            <a href="index.php" class="back-button"><i class="fas fa-arrow-left"></i> Volver</a>

            <img src="css/images/logo.png" style="width: 300px;" class="concertlogo">
            <h3 style="text-decoration:underline; text-decoration-thickness: 5px; text-decoration-color: #0D7377;">Inicio de Sesión</h3>
            ...
            <input type="button" name="forgot" value="¿Olvidó su contraseña?" class="btn" style="background-color:#0D7377"
