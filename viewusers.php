...
<body>
    <main class="table">
        <section class="table__header">
            <h1>Información de Usuarios de Concierto</h1>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edituser.php?id=<?php echo $row['id'] ?>" class="link-dark">
                        ...
                        function updateTable(data) {
                            ...
                            if (data.length > 0) {
                                $.each(data, function(index, row) {
                                    ...
                                    newRow += '<td>';
                                    newRow += '<a href="editcust.php?id=' + row.id + '" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-2"></i></a>';
                                    newRow += '<a href="#" onclick="confirmDelete(' + row.id + ')" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>';
                                    newRow += '</td>';
                                    newRow += '</tr>';
                                    tableBody.append(newRow);
                                });
                            } else {
                                var noResultsRow = '<tr><td colspan="11">No se encontraron resultados</td></tr>';
